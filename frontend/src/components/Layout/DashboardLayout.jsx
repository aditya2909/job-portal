    ...
    <div className="flex h-screen bg-gray-50">
      ...
      >
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <button
            className="w-full flex items-center  px-3 py-2.5 text-sm font-medium rounded-lg text-gray-600 hover:bg-gray-50 hover:text-gray-900 transtion-all duration-300"
            onClick={logout}
          >
      ...
      >
        ...
        <header className="bg-white/80 backdrop-blur-sm border-b border-gray-200 h-16 flex items-center justify-between px-6 sticky top-0 z-30">
          <div className="flex item-center space-x-4">
            ...
            <div>
              <h1 className="text-base font-semibold text-gay-600">
                Welcome back!
              </h1>
