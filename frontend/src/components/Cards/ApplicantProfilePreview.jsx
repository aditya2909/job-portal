...
const ApplicantProfilePreview = ({
  ...
  const onChange = async (e) => {
    ...
    try {
      ...
      setCurrentStatus(selectedApplicant.status); // Revert to previous status on error
        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 p-4 rounded-lg">
              <h5 className="font-medium text-gray-900 mb-2">Applied Profile</h5>
              <p className="text-gray-700">
                {selectedApplicant.job.title || "No profile provided."}
              </p>
              <p className="text-gray-600 text-sm mt-1">
                {selectedApplicant.job.location || "No location provided."} 💠 {selectedApplicant.job.type || "No job type provided."}
              </p>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="mt-4">
              ...
              <select
                value={currentStatus}
                onChange={onChange}
                className="w-full border border-gray-300 rounded-lg p-2 focus:border-blue-500 focus:ring-blue-500"
                disabled={loading}
              >
