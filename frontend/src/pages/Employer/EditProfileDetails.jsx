              ...
              <div className="p-8">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                          ...
                          <input
                            type="file"
                            accept="image/*"
                            className="block w-full text=sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-green-700 hover:file:bg-green-100 transition-colors"
                ...
                <div className="flex justify-end space-x-4 mt-8 pt-6 border-t">
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 transition-colors flex items-center space-x-2 disabled:cursor-not-allowed"
                  >
                    {saving ? (
