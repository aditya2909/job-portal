...
const JobPostingForm = () => {
  ...
  const validateForm = (formData) => {
    ...
    if (!formData.salaryMin || !formData.salaryMax) {
      errors.salary = "Both minimum and mximum salary are required";
  ...
  return (
    <DashboardLayout activeMenu="post-job">
      <div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50/30 to-purple-50/20 py-8 px-4 sm:px-6 lg:px-6=8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white shadow-xl rounded-2xl p-6">
            <div className="flex items-center justify-between mb-8">
              <div>
                <h2 className="text-xl font-bold bg-linear-to-r from-gray-900 to to-gray-600 bg-clip-text text-transparent">
                  Post a New Job
                </h2>
            ...
            <div className="space-y-4">
              ...
              <TextareaField
                ...
                id="description"
                placeholder="Describe the role and responsibiities..."
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg text-base transition-colors duration-200 focus:outline-none focus:border-blue-500 focus:ring-blue-500 focus:ring-opacity-20"
                    />
                  </div>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-10">
