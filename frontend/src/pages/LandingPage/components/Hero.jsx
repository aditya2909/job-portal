  ...
  return (
    <section className="pt-24 pb-16 bg-white min-h-screen flex items-center">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="group bg-linear-to-r from-blue-600 to-purple-600 text-white py-4 px-8 rounded-xl flex items-center text-lg space-x-2 font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl"
          ...
          >
            {stats.map((stat, index) => (
              <motion.div
                ...
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
                transform={{ delay: 0.8 + index * 0.1, duration: 0.6 }}
                className="flex flex-col items-center space-y-2 p-4 rounded-xl hover:bg-gray-50 transition-colors"
              >
                <div className="w-12 h-12 bg-linear-to-r from-blue-100 to-purple-100 rounded-xl flex items-center justify-center mt-2">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 right-10 w-32 h-32 bg-purple-100 rounded-full blur-3xl opacity-30" />
