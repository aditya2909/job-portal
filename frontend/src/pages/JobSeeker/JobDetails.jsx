                ...
                <div className="flex items-center gap-3 mb-6">
                  {jobDetails?.company?.companyLogo ? (
                    <img
                      ...
                      alt="Company Logo"
                      className="w-20 h-20 object-cover rounded-2xl border-4 border-white/20 shadow-lg"
                    />
                  ) : (
            ...
            <div className="px-0 pb-8 space-y-8">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-lg font-bold text-gray-900">
                          ...
                          <span className="text-lg font-normal text-gray-900 ml-1">
                            per year
                          </span>
                        </div>
                      </div>
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-gray-900 flex items-center space-x-3">
                  <div className="w-1 h-8 bg-linear-to-r from-blue-500 to-purple-600 rounded-full"></div>
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-gray-900 flex items-center space-x-3">
                  <div className="w-1 h-8 bg-linear-to-r from-purple-500 to-pink-600 rounded-full"></div>
